  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_25%_25%,rgba(102,126,234,.15),transparent_50%),radial-gradient(circle_at_75%_75%,rgba(118,75,162,.15),transparent_50%)] pb-10">
      <div className="max-w-7xl mx-auto px-6 pt-16">
        ...
        {/* Search */}
        <div className="rounded-2xl border border-white/15 bg-white/10 backdrop-blur-xl p-6 mb-6 shadow-lg shadow-indigo-500/10">
          <h2 className="text-white font-semibold mb-4 flex items-center gap-2 text-lg">
            <span className="bg-gradient-to-r from-indigo-500 to-purple-500 p-2 rounded-full">🔎</span> 
            Search Student Records
          </h2>
          <form ref={formRef} onSubmit={search} className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-4">
            <div className="relative">
              <input
                name="registration"
                className="w-full rounded-xl border border-white/15 bg-white/90 px-4 py-3 pl-10 outline-none focus:ring-2 focus:ring-indigo-400 text-gray-900 transition-all duration-300"
                placeholder="Enter registration number (e.g., CUTM1234567)"
                value={registration}
            ...
            <button 
              className="rounded-xl bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold px-6 py-3 
                        disabled:opacity-50 hover:shadow-lg hover:shadow-indigo-500/20 transition-all duration-300
          ...
          <div className="mt-3 text-xs text-white/60">
            Press <kbd className="px-2 py-0.5 rounded bg-white/10 text-white/80 font-mono">Ctrl</kbd> + <kbd className="px-2 py-0.5 rounded bg-white/10 text-white/80 font-mono">Enter</kbd> to search quickly
          </div>
        </div>
