...
export default function AdminDashboardPKD() {
    ...
    >
      ...
      <section className="pt-12 sm:pt-16 pb-6 sm:pb-8 text-center px-3 sm:px-6">
        <div className="mx-auto max-w-5xl">
          ...
          >
            CUTM PKD - Admin Dashboard
          </h1>
          <p className="text-[#5A6C7D] text-sm sm:text-base font-medium">
            Manage and monitor your academic platform - PKD Campus
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
            <SchoolCard
              ...
              onClick={() => {
                ...
                localStorage.setItem('selectedCampus', 'pkd');
                router.push('/dashboard/admin/pkd/soet');
              }}
            ...
            <SchoolCard
              ...
              onClick={() => {
                ...
                localStorage.setItem('selectedCampus', 'pkd');
                router.push('/dashboard/admin/pkd/sovet');
              }}
