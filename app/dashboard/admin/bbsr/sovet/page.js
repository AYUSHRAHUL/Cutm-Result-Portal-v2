...
export default function AdminDashboardBBSRSOVET() {
  ...
  // Centurion University - SOVET School Data
  const targetCounts = useMemo(() => ({ students: 1247, records: 342, backlogs: 34, health: 94 }), []);
  ...
  const go = (path) => {
    ...
    const school = localStorage.getItem('selectedSchool') || 'sovet';
    ...
    return (
      ...
      >
        ...
        <div className="text-white/90 text-sm sm:text-base text-center px-4 font-semibold">
          🔐 Secure Admin Access - Centurion University - SOVET
        </div>
    ...
    >
      ...
      <section className="pt-12 sm:pt-16 pb-6 sm:pb-8 text-center px-3 sm:px-6">
        <div className="mx-auto max-w-5xl">
          ...
          >
            Centurion University - SOVET - Admin Dashboard
          </h1>
          <p className="text-[#5A6C7D] text-sm sm:text-base font-medium">
            School of Vocational & Emerging Technology - BBSR Campus
          </p>
        </div>
      </section>
