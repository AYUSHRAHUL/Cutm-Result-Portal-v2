    ...
    >
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 pt-6 sm:pt-8 lg:pt-12">
        <div className="mb-4 sm:mb-6 text-center">
          ...
          >
            🏫 SOET Batch Data Portal
          </h1>
          <p className="text-gray-600 mt-2">School of Engineering & Technology</p>
        </div>
        ...
        <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-xl bg-white border-2" style={{ borderColor: "rgba(5,163,199,0.2)" }}>
          ...
          >
            <h2 className="text-lg sm:text-xl font-black">Search B.Tech Student Records</h2>
            <p className="opacity-90 text-xs sm:text-sm mt-1">View SOET student data by branch and batch</p>
          </div>
          ...
          <div className="p-4 sm:p-6">
            <form onSubmit={onSubmit} className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
              ...
              <div className="text-center">
                ...
                >
                  {loading ? "Loading..." : "Get SOET Batch Data"}
                </button>
              </div>
            </form>
