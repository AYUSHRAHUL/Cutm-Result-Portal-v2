...
/**
 * GET /api/soet/result-data/subjects
...
export async function GET(req) {
  ...
  try {
    ...
    records = records.filter(record => {
      ...
      const branchCodeMap = {
        '111': ['CIVIL', 'Civil', 'Civil Engineering'],
        '112': ['CSE', 'Computer Science Engineering', 'Computer Science and Engineering'],
        '113': ['ECE', 'Electronics & Communication Engineering', 'Electronics and Communication Engineering'],
        '115': ['EEE', 'Electrical & Electronics Engineering', 'Electrical and Electronics Engineering'],
        '116': ['ME', 'MECHANICAL', 'Mechanical Engineering', 'Mechanical'],
