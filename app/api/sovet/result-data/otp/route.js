...
export async function POST(req) {
  try {
    ...
    // NB: this previously called sendEmail(to, subject, html) positionally, but
    // sendEmail takes a single options object - so `to` was always undefined and
    // this route could never send an OTP at all.
