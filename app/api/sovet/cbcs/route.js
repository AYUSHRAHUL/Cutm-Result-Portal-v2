...
/**
 * SOVET CBCS Route - Diploma subjects only
 */
export async function GET(req) {
  try {
    ...
    console.error("SOVET CBCS GET error", err);
...
export async function POST(req) {
  try {
    ...
    console.log(`[SOVET CBCS POST] Database selection: campus=${campus}, school=${school}, dbName=${dbName}`);
    ...
    console.error("SOVET CBCS POST error", err);
    return NextResponse.json({ error: "Server error" }, { status: 500 });
  }
}
